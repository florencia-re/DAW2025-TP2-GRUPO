...
use App\Http\Controllers\Auth\AuthExternalSessionController;
...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request): RedirectResponse
    {
        ...
        $external = new AuthExternalSessionController();

        // Autenticarse en la API externa
        $external->authenticateWithExternalApi($user->name, $request->input('password'));
